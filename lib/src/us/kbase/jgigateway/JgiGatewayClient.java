...
/**
 * <p>Original spec-file module name: jgi_gateway</p>
 * <pre>
 * A KBase module: jgi_gateway
 * </pre>
 */
public class JgiGatewayClient {
     ...
     */
    public JgiGatewayClient(URL url) {
     ...
     * validity.
     */
    public JgiGatewayClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public JgiGatewayClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public JgiGatewayClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("jgi_gateway.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
