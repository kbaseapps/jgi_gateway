...
function jgi_gateway_eap(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    ...
    var _auth_cb = auth_cb;
     ...
     this.search_jgi = function (input, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "jgi_gateway_eap.search_jgi",
            [input], 2, _callback, _errorCallback);
    };
 
     this.stage_objects = function (input, _callback, _errorCallback) {
        if (typeof input === 'function')
            throw 'Argument input can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "jgi_gateway_eap.stage_objects",
            [input], 2, _callback, _errorCallback);
    };
 
     this.stage_status = function (job_id, _callback, _errorCallback) {
