...
function jgi_gateway(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    ...
    var _auth_cb = auth_cb;
     ...
     this.search_jgi = function (search_string, _callback, _errorCallback) {
        if (typeof search_string === 'function')
            throw 'Argument search_string can not be a function';
        ...
        return json_call_ajax(_url, "jgi_gateway.search_jgi",
            [search_string], 1, _callback, _errorCallback);
    };
     ...
     this.stage_objects = function (input, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "jgi_gateway.stage_objects",
